...
%何故我々はこのような高度な
{\bf 人工知能という言葉は、人間のように高度な先読みをし、高度な行動計画を行い実行の出来るシステムを作るという野望が言葉になったものである！}
...
{\todo Grid Pathfinding: なんかいい感じの絵}
\begin{figure}
...
{\todo ヒューリスティックとは: grid, grid-brfsの図を挿入}
